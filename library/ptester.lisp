...
;; $Id: ptester.lisp,v 1.1.1.1 2004-06-13 22:36:25 robmyers Exp $
...
(defvar *unit-tests* '()
  "All the unit tests registered by the code.")

(defmacro deftest (&rest body)
  "Define a test and register it to be called by (run-tests) ."
  `(setf *unit-tests*
	 (cons (lambda () ,@body)
	       *unit-tests*)))
